...
export function renderOpaqueActorPass(host: WebGLOsrsRendererHost, 
        ...
        for (let i = 0; i < host.mapManager.visibleMapCount; i++) {
            ...
            host.playerRenderer.renderOpaqueForMap(map, actorDataTextureIndex, actorDataTexture);
            ...
            try {
                ...
                if (host.gfxRenderer && (baseOffsetPlayer !== -1 || baseOffsetNpcForGfx !== -1)) {
                    // Reuse object to avoid per-call allocation
                    host.gfxRenderPassOffsets.player =
                        baseOffsetPlayer !== -1 ? baseOffsetPlayer : undefined;
                    host.gfxRenderPassOffsets.npc =
