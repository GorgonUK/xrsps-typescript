...
import { createSpecialAttackProvider } from "../server/gamemodes/vanilla/combat/SpecialAttackRegistry";
import { CombatEffectApplicator } from "../server/src/game/combat/CombatEffectApplicator";
import type { SpecialAttackEffects } from "../server/src/game/combat/CombatState";
import { type NpcCombatProfile, NpcState } from "../server/src/game/npc";
