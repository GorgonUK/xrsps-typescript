/**
 * Static npc_kill matrix checks for Phase 7B-1b.
 *
 * Usage: npx tsx server/scripts/leagues/verify-phase7b-slice1b-matrices.ts
 */
import fs from "fs";
...
function main(): void {
    ...
    console.log("[verify-phase7b-slice1b-matrices] Phase 7B-1b npc_kill checks\n");
    ...
    const matrixSamples: Array<{
        ...
        { label: "Giant Mole", sourceTaskId: 590, npcId: 5779 },
        { label: "Callisto", sourceTaskId: 641, npcId: 6609 },
        { label: "Thermonuclear Smoke Devil", sourceTaskId: 602, npcId: 499 },
        { label: "Chaos Elemental", sourceTaskId: 587, npcId: 2054 },
        { label: "Rock Crab (Fremennik)", sourceTaskId: 897, npcId: 100 },
        { label: "Revenant Knight", sourceTaskId: 583, npcId: 7939 },
    ];
    ...
    if (failed > 0) {
        console.error(`\n[verify-phase7b-slice1b-matrices] ${failed} check(s) failed`);
        process.exit(1);
    }
    console.log("\n[verify-phase7b-slice1b-matrices] All Slice 1b matrix checks passed");
}
