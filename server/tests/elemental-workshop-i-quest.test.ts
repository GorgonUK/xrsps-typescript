...
import { elementalWorkshopIQuest } from "../gamemodes/vanilla/quests/definitions/elementalWorkshopI";
import {
    BIT,
    ITEM,
    LOC,
...
} from "../gamemodes/vanilla/quests/definitions/elementalWorkshopI/constants";
