...
import { BARCRAWL_CARD, BARCRAWL_COMPLETE, BARS, COINS, VARP_BARCRAWL } from "../gamemodes/vanilla/quests/definitions/barCrawl/constants";
import { scorpionCatcherQuest } from "../gamemodes/vanilla/quests/definitions/scorpionCatcher";
import {
    ITEM,
    LOC,
    NPC,
...
} from "../gamemodes/vanilla/quests/definitions/scorpionCatcher/constants";
