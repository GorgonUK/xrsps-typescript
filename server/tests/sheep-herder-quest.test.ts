...
import groundItems from "../gamemodes/vanilla/data/groundItemSpawnData.json";
import { sheepHerderQuest } from "../gamemodes/vanilla/quests/definitions/sheepHerder";
import {
    ITEM,
    LOC,
    NPC,
    ...
    VARP_SHEEP_DISPOSAL,
    VARP_SHEEP_HERDER,
} from "../gamemodes/vanilla/quests/definitions/sheepHerder/constants";
