...
function showSkillLevelUp(
    ...
    queueWidget(services, playerId, {
        ...
        text: `<col=000080>Congratulations, you just advanced ${fmt} ${skillName} level${s}.`,
    });
    queueWidget(services, playerId, {
        action: "set_text",
...
function showCombatLevelUp(
    ...
    queueWidget(services, playerId, {
        action: "set_text",
        uid: (LEVELUP_INTERFACE_ID << 16) | LEVELUP_TEXT1_COMPONENT,
        text: `<col=000080>Congratulations, you just advanced ${fmt} combat level${s}.`,
    });
    queueWidget(services, playerId, {
        action: "set_text",
        uid: (LEVELUP_INTERFACE_ID << 16) | LEVELUP_TEXT2_COMPONENT,
        text: `Your combat level is now ${newLevel}.`,
    });
    queueWidget(services, playerId, {
        action: "set_text",
        uid: (LEVELUP_INTERFACE_ID << 16) | LEVELUP_CONTINUE_COMPONENT,
