...
export async function initShaders(host: WebGLOsrsRendererHost, ): Promise<Program[]> {
        ...
        try {
            host.gfxManager = new GfxManager(this);
            host.gfxRenderer = new GfxRenderer(this, host.gfxManager);
        } catch {}

        // Init projectile manager and renderer
        try {
            host.projectileManager = new ProjectileManager(this);
            host.projectileRenderer = new ProjectileRenderer(this, host.projectileManager);
        } catch {}
